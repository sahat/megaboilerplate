    ...
    const nodeTemplateEngines = (props.platform === 'node') ? (
      <div className="radio-group">
        <label className="radio-inline">
          <img className="btn-logo" src="http://megaboilerplate.com/img/svg/jade-logo.svg" height="60" alt="Jade"/>
          <input type="radio" name="templateEngineRadios" value="jade" onChange={props.handleChange} checked={props.templateEngine === 'jade'}/>
          <span>Jade</span>
        </label>
        <label className="radio-inline">
          <img className="btn-logo" src="http://megaboilerplate.com/img/svg/handlebars-logo.svg" alt="Handlebars"/>
        ...
        <label className="radio-inline">
          <img className="btn-logo" src="http://megaboilerplate.com/img/svg/nunjucks-logo.png" alt="Nunjucks"/>
