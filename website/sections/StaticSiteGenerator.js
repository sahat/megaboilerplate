        ...
        <div className="panel-body">
          ...
          <div className="radio-group">
            <label className="radio-inline">
              <img className="btn-logo" src="http://megaboilerplate.com/img/svg/jekyll-logo.svg" alt="Jekyll"/>
            ...
            <label className="radio-inline">
              <img className="btn-logo" src="http://megaboilerplate.com/img/svg/middleman-logo.svg" alt="Middleman"/>
