        ...
        <div className="panel-body">
          ...
          <div className="radio-group">
            <label className="radio-inline">
              <img className="btn-logo" src="http://megaboilerplate.com/img/svg/none.png" alt="None"/>
              <input type="radio" name="jsFrameworkRadios" value="none" onChange={props.handleChange} checked={props.jsFramework === 'none'}/>
              <span>None</span>
              {recommended}
            </label>
            <label className="radio-inline">
              <img className="btn-logo" src="http://megaboilerplate.com/img/svg/react-logo.svg" alt="React"/>
              <input type="radio" name="jsFrameworkRadios" value="react" onChange={props.handleChange} checked={props.jsFramework === 'react'}/>
              <span>React</span>
            </label>
            <label className="radio-inline">
              <img className="btn-logo" src="http://megaboilerplate.com/img/svg/angularjs-logo.svg" alt="AngularJS"/>
            ...
            <label className="radio-inline hint--right hint--rounded" data-hint="ETA after Angular 2 final release">
              <img className="btn-logo disabled" src="http://megaboilerplate.com/img/svg/angular2.png" alt="Angular 2"/>
