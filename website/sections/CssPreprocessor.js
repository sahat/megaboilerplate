  ...
  render() {
    ...
    const cssRadio = (!BOURBON_NEAT && (NO_CSS_FRAMEWORK || JEKYLL || MIDDLEMAN || BOOTSTRAP || FOUNDATION)) ? (
      <label className="radio-inline">
        <img className="btn-logo" src="http://megaboilerplate.com/img/svg/css3-logo.svg" alt="CSS"/>
    ...
    const sassRadio = (NO_CSS_FRAMEWORK || JEKYLL || MIDDLEMAN || BOOTSTRAP || FOUNDATION || BOURBON_NEAT) ? (
      <label className="radio-inline">
        <img className="btn-logo" src="http://megaboilerplate.com/img/svg/sass-logo.svg" alt="Sass"/>
    ...
    const lessRadio = (!JEKYLL && !MIDDLEMAN && (NO_CSS_FRAMEWORK || BOOTSTRAP)) ? (
      <label className="radio-inline">
        <img className="btn-logo" src="http://megaboilerplate.com/img/svg/less-logo.svg" alt="LESS"/>
    ...
    const postcssRadio = (!JEKYLL && !MIDDLEMAN && (NO_CSS_FRAMEWORK)) ? (
      <label className="radio-inline">
        <img className="btn-logo" src="http://megaboilerplate.com/img/svg/postcss.svg" alt="PostCSS"/>
    ...
    const stylusRadio = (!JEKYLL && !MIDDLEMAN && (NO_CSS_FRAMEWORK)) ? (
      <label className="radio-inline">
        <img className="btn-logo" src="http://megaboilerplate.com/img/svg/stylus-logo.svg" alt="Stylus"/>
    ...
    const additionalOptionsButton = (BOOTSTRAP || FOUNDATION) && (CSS || LESS || SASS) ? (
      <div>
        <span className="options" onClick={this.toggleAdditionalOptions}>
          <img className={cx('animated', { fast: state.showOptions })} src="http://megaboilerplate.com/img/svg/options.svg"/>
