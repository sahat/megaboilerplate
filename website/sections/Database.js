      ...
      <div ref="database" className={cx('zoomInBackwards panel', props.database)}>
        ...
        <div className="panel-body">
          ...
          <div className="radio-group">
            ...
            <label className="radio-inline">
              <img className="btn-logo" src="http://megaboilerplate.com/img/svg/mongodb-logo.svg" alt="MongoDB" />
              <input type="radio" name="databaseRadios" value="mongodb" onChange={props.handleChange} checked={props.database === 'mongodb'} />
              <span>MongoDB</span>
              {recommended}
            </label>
            <label className="radio-inline">
              <img className="btn-logo" src="http://megaboilerplate.com/img/svg/mysql-logo.svg" alt="MySQL" />
              <input type="radio" name="databaseRadios" value="mysql" onChange={props.handleChange} checked={props.database === 'mysql'} />
              <span>MySQL</span>
            </label>
            <label className="radio-inline">
              <img className="btn-logo" src="http://megaboilerplate.com/img/svg/postgresql-logo.svg" alt="PostgreSQL" />
              <input type="radio" name="databaseRadios" value="postgresql" onChange={props.handleChange} checked={props.database === 'postgresql'} />
              <span>PostgreSQL</span>
            </label>
            <label className="radio-inline">
              <img className="btn-logo" src="http://megaboilerplate.com/img/svg/sqlite-logo.svg" alt="SQLite3" />
