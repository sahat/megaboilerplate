  ...
  render() {
    ...
    const mochaRadio = (
      <label className="radio-inline">
        <img className="btn-logo" src="http://megaboilerplate.com/img/svg/mocha.svg" alt="Mocha"/>
    ...
    const jasmineRadio = props.jsFramework === 'angularjs' ? (
      <label className="radio-inline">
        <img className="btn-logo" src="http://megaboilerplate.com/img/svg/jasmine.svg" alt="Jasmine"/>
      ...
      <label className="radio-inline hint--top hint--rounded" data-hint="Coming soon">
        <img className="btn-logo disabled" src="http://megaboilerplate.com/img/svg/jasmine.svg" alt="Jasmine"/>
