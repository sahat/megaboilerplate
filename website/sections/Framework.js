    ...
    const nodeFrameworks = props.platform === 'node' ? (
      <div className="radio-group">
        <label className="radio-inline">
          <img className="btn-logo express" src="http://megaboilerplate.com/img/svg/express-logo.png" alt="Express"/>
        ...
        <label className="radio-inline hint--top hint--rounded" data-hint="Coming soon">
          <img className="btn-logo disabled" src="http://megaboilerplate.com/img/svg/meteor-logo.png" alt="Meteor"/>
