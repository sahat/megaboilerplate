    ...
    <div className={cx('zoomInBackwards panel', props.deployment)}>
      ...
      <div className="panel-body">
        ...
        <div className="radio-group">
          ...
          <label className="radio-inline">
            <img className="btn-logo" src="http://megaboilerplate.com/img/svg/heroku-logo.svg" height="60" alt="Heroku"/>
            <input type="radio" name="deploymentRadios" value="heroku" onChange={props.handleChange} checked={props.deployment === 'heroku'} />
            <span>Heroku</span>
          </label>
          <label className="radio-inline">
            <img className="btn-logo" src="http://megaboilerplate.com/img/svg/azure-logo.svg" height="60" alt="Microsoft Azure"/>
            <input type="radio" name="deploymentRadios" value="azure" onChange={props.handleChange} checked={props.deployment === 'azure'} />
            <span>Microsoft Azure</span>
          </label>
          <label className="radio-inline">
            <img className="btn-logo" src="http://megaboilerplate.com/img/svg/do-logo.png" alt="Digital Ocean"/>
