...
const NextSteps = (props) => {
  ...
  if (props.framework === 'express') {
    gettingStarted.framework = 'Express';
    gettingStarted.frameworkUrl = '-express';
  }
  ...
  let gettingStartedText = `See how to <a href="https://github.com/sahat/boilerplate#${urlMap[props.framework]}" target="_blank">get started</a> with <strong>${nameMap[props.framework]}</strong>`;
  ...
  if (props.authentication && props.authentication.size) {
    gettingStartedText += ` Then go to <a href="https://github.com/sahat/boilerplate/README.md#obtaining-api-keys">Obtaining API Keys</a> to learn how to generate your own OAuth keys.`;
  }
